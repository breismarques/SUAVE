...
from SUAVE.Analyses.Mission.Segments.Climb.Unknown_Throttle_VSP import Unknown_Throttle_VSP
...
## @ingroup Analyses-Mission-Segments-Descent
class Constant_Speed_Constant_Rate_VSP(Unknown_Throttle_VSP):
