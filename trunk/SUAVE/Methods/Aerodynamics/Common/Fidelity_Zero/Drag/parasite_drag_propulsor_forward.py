...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Drag
def parasite_drag_propulsor_forward(state,settings,geometry):
    ...
    propulsor = geometry
    Sref      = propulsor.nacelle_diameter_forward**2. / 4. * np.pi
    Swet      = propulsor.areas.wetted
    
    l_prop = propulsor.engine_length_forward
    d_prop = propulsor.nacelle_diameter_forward
